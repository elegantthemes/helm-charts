...
Intake deploys roll (`maxSurge: 1`). Consumer deploys drain in 120s: stop fetch, interrupt Cursor, requeue fix/feedback for phase skip, exit. Kubernetes grace is 120s consumer / 30s intake. s6 service grace is aligned (not the 3s default).
